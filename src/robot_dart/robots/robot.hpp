...
namespace robot_dart {
    ...
    namespace robots {
        ...
        public:
            ...
            std::vector<std::string> dof_names(bool filter_mimics = false,
                bool filter_locked = false, bool filter_passive = false) const;
            ...
            static std::shared_ptr<Robot> create_box(const Eigen::Vector3d& dims,
                ...
                const std::string& type = "free", double mass = 1.0,
