...
namespace robot_dart {
    ...
    namespace robots {
        ...
        void Robot::set_actuator_type(
            size_t dof, dart::dynamics::Joint::ActuatorType type, bool override_mimic)
        {
        ...
        void Robot::set_actuator_types(
            dart::dynamics::Joint::ActuatorType type, bool override_mimic)
        {
            for (size_t i = 0; i < _skeleton->getNumDofs(); ++i) {
                auto jt = _skeleton->getDof(i)->getJoint();
#if DART_VERSION_AT_LEAST(6, 7, 0)
