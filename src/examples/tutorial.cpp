...
std::shared_ptr<robot_dart::robots::Robot> random_sphere(size_t num = 0)
{
    ...
    return robot_dart::robots::Robot::create_ellipsoid(size, pose, "free", 1., dart::Color::Blue(1.0), "sphere_" + std::to_string(num));
}
...
int main()
{
    ...
    // add a simple arm
    auto arm_robot = std::make_shared<robot_dart::robots::Robot>("res/robots/arm.urdf");
