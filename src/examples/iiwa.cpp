...
int main()
{
    ...
    std::vector<std::pair<std::string, std::string>> packages = {{"iiwa14", std::string(RESPATH) + "/robots/iiwa/meshes"}};
    auto global_robot = std::make_shared<robot_dart::robots::Robot>(std::string(RESPATH) + "/robots/iiwa/iiwa14.urdf", packages);
