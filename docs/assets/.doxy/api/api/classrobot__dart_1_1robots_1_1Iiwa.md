...
# Class robot\_dart::robots::Iiwa



[**ClassList**](annotated.md) **>** [**robot\_dart**](namespacerobot__dart.md) **>** [**robots**](namespacerobot__dart_1_1robots.md) **>** [**Iiwa**](classrobot__dart_1_1robots_1_1Iiwa.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Iiwa**](#function-iiwa) (size\_t frequency=1000, const std::string & urdf="iiwa/iiwa.urdf", const std::vector&lt; std::pair&lt; std::string, std::string &gt; &gt; & packages={{"iiwa\_description", "iiwa/iiwa\_description"}}) <br> |
